...
<Tabs groupId="interface">
  ...
  1. [Launch the installer](goose-plus://extension?cmd=npx&arg=-y&arg=vscode-mcp-server&id=vscode-mcp&name=VS%20Code%20MCP&description=VS%20Code%20integration%20and%20file%20operations)
