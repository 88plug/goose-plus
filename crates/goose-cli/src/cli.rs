...
#[derive(Parser)]
#[command(name = "goose-plus", author, version, display_name = "", about, long_about = None)]
pub struct Cli {
    #[command(subcommand)]
...
enum SessionCommand {
    ...
    Import {
        #[arg(
            help = "Path to a goose session export, a Claude Code, Codex, or Pi .jsonl transcript, or a goose-plus://sessions/nostr share link"
        )]
        input: String,
