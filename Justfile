...
package-ui:
    ...
    codesign --force --deep --sign - --entitlements ui/desktop/entitlements.plist ui/desktop/out/goose-plus-darwin-arm64/goose-plus.app
    @echo "Done! Launch with: open ui/desktop/out/goose-plus-darwin-arm64/goose-plus.app"
